...
var (
	MainnetGenesisHash = common.HexToHash("0x70cefc67ff52eb3e1ea9fc9e721d0458a952632927d2d7cb435b250c0c32e653")
...
var (
	...
	MainnetChainConfig = &ChainConfig{
		...
		RobinHoodBlock:      big.NewInt(2700000),
	...
	TestnetChainConfig = &ChainConfig{
		...
		RobinHoodBlock:      big.NewInt(2620487),
	...
	TestChainConfig = &ChainConfig{big.NewInt(1), big.NewInt(0), nil, false, big.NewInt(0), common.Hash{}, big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), big.NewInt(0), nil, nil, nil, new(EthashConfig), nil}
...
type ChainConfig struct {
	...
	RobinHoodBlock      *big.Int `json:"robinHoodBlock,omitempty"`      // RobinHood switch block (nil = no fork, 0 = already activated)
...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v RobinHood: %v Constantinople: %v  Petersburg: %v Istanbul: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
// IsRobinHood returns whether num is either equal to the RobinHood fork block or greater.
func (c *ChainConfig) IsRobinHood(num *big.Int) bool {
	return isForked(c.RobinHoodBlock, num)
}
...
type Rules struct {
	...
	IsByzantium, IsConstantinople, IsPetersburg, IsRobinHood, IsIstanbul bool
}
