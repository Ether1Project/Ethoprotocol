...
func (c *ChainConfig) String() string {
	...
	return fmt.Sprintf("{ChainID: %v Homestead: %v DAO: %v DAOSupport: %v EIP150: %v EIP155: %v EIP158: %v Byzantium: %v RobinHood: %v Constantinople: %v  Petersburg: %v Engine: %v}",
		c.ChainID,
		c.HomesteadBlock,
		c.DAOForkBlock,
		c.DAOForkSupport,
...
type Rules struct {
	...
	IsByzantium, IsConstantinople, IsPetersburg, IsRobinHood bool
}
