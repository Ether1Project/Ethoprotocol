...
var (
	FrontierBlockReward    *big.Int = big.NewInt(10e+18) // Block reward in wei for successfully mining a block
	ByzantiumBlockReward   *big.Int = big.NewInt(10e+18) // Block reward in wei for successfully mining a block upward from Byzantium
	
	minerBlockReward               *big.Int = big.NewInt(10e+18)
